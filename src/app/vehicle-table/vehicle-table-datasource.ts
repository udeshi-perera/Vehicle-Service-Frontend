...
//const EXAMPLE_DATA: VehicleTableItem[] = 
 //[
  // {id: 1, name: 'Hydrogen'},
  // {id: 2, name: 'Helium'},
  // {id: 3, name: 'Lithium'},
 ...
 */
export class VehicleTableDataSource extends DataSource<IVehicle> {
  public data: Vehicle[] = [];
   ...
   */
  private getPagedData(data: IVehicle[]): IVehicle[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: IVehicle[]): IVehicle[] {
